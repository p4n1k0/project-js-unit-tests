const { createMenu, addConsumption, addOrder, resetOrder, totalPay } = require('../src/restaurant');
...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(Object.keys(menu)).toEqual(Object.keys({ food: {}, drink: {} }));
    ...
    // ```
    totalPay(menu);
    expect(menu.pay()).toBeCloseTo(11.7);
